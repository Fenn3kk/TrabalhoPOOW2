...
public class AdministradorController {
    ...
    public ResponseEntity<Administrador> buscarAdministradorPorUUID(
    ...
    @PostMapping("/salvar")
    @Transactional
    public ResponseEntity<Administrador> salvarAdministrador(@RequestBody @Valid Administrador administrador, UriComponentsBuilder uriBuilder) {
    ...
    public ResponseEntity<Administrador> atualizarAdministradorPorUUID(@RequestBody @Valid Administrador administrador) {
    ...
    public ResponseEntity<Void> deletarAdministradorPorUUID(
